...
{
    public class BaseAdminPage : System.Web.UI.Page, BVSoftware.Commerce.Controls.IBaseAdminPage, IMultiStorePage
    {
        ...
        public BVSoftware.Commerce.Accounts.UserAccount CurrentUser
        {
            get
            {
