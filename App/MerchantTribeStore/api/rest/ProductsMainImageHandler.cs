...
namespace BVCommerce.api.rest
{
    ...
    {
        public ProductsMainImageHandler(BVSoftware.Commerce.BVApplication app)
            : base(app)
        {
        ...
        public override string PostAction(string parameters, System.Collections.Specialized.NameValueCollection querystring, string postdata)
        {
            ...
            try
            {
                ...
                response.Content = BVSoftware.Commerce.Storage.DiskStorage.UploadProductImage(BVApp.CurrentStore.Id, bvin, fileName, postedData);
            }
            catch(Exception ex)
            {
