...
namespace MerchantTribeStore.Areas.signup.Controllers
{
    ...
    {        
        ...
        {
            List<FeatureSection> model = LoadFeatureSections();
            return View(model);
        }
        private List<FeatureSection> LoadFeatureSections()
        {
            List<FeatureSection> sections = new List<FeatureSection>();

            sections.Add(new FeatureSection() { Name = "Categories", Features = GetCategories() });
            
            sections.Add(new FeatureSection() { Name = "Products", Features =  GetProducts()});
            sections.Add(new FeatureSection() { Name = "Marketing", Features =  GetMarketing()});
            //sections.Add(new FeatureSection() { Name = "Development", Features =  GetDevelopment()});
            sections.Add(new FeatureSection() { Name = "Search", Features =  GetSearch()});
            sections.Add(new FeatureSection() { Name = "Customers", Features =  GetCustomers()});
            sections.Add(new FeatureSection() { Name = "Loyalty", Features =  GetLoyalty()});
            sections.Add(new FeatureSection() { Name = "Affiliates", Features =  GetAffiliateProgram()});
            sections.Add(new FeatureSection() { Name = "Content Management", Features =  GetContentManagement()});
            sections.Add(new FeatureSection() { Name = "Order Management", Features =  GetOrderManagement()});
            sections.Add(new FeatureSection() { Name = "Taxes", Features =  GetTaxes()});
            sections.Add(new FeatureSection() { Name = "Payment", Features =  GetPayment()});
            sections.Add(new FeatureSection() { Name = "Shipping", Features =  GetShipping()});
            sections.Add(new FeatureSection() { Name = "Security", Features =  GetSecurity()});
            sections.Add(new FeatureSection() { Name = "Design", Features =  GetDesign()});
            sections.Add(new FeatureSection() { Name = "Reports", Features = GetReports() });
            //sections.Add(new FeatureSection() { Name = "Integration", Features =  GetIntegration()});

            return sections;
        }
        #region FeatureHelpers
        private List<FeatureDetails> GetCategories()
        {
            ...
            result.Add(new FeatureDetails() { Name = "6 Built-in Templates + Unlimited Plug-ins", Description = "Choose from our included designs or easily add your own! Unlike in other software packages, you can have different page layouts for each category and subcategory. This is an amazing feature for merchants who sell different kinds of items on one store. ", ImageId = "A3" });
        ...
        {
            List<FeatureDetails> result = new List<FeatureDetails>();
            result.Add(new FeatureDetails() { Name = "6 Built-in Product Templates + Unlimited Plug-ins", Description = "Choose from six product page layouts or easily add your own.", ImageId = "B1" });
