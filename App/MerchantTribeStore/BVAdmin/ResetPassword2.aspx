            ...
            <div id="login">                   
                   ...
                   <table cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td class="formfield">
                            <asp:TextBox ID="ResetKeyField" runat="server" ToolTip="Reset Key" Width="200px"></asp:TextBox></td>
                    </tr>    
                    <tr>
                        <td class="formlabel">
                            New Password:
                        ...
                        <td class="formfield">
                            <asp:TextBox ID="PasswordField" runat="server" TextMode="Password" ToolTip="Password"
                                Width="200px"></asp:TextBox></td>
                    </tr>                
                    <tr>
                        <td class="formlabel">&nbsp;</td>
                        <td class="formfield">                            
                            <asp:LinkButton ID="lnkReset" runat="server" Text="<b>Set New Password</b>" 
