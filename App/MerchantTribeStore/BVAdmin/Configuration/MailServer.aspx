<%@ Page Language="C#" MasterPageFile="~/BVAdmin/BVAdminNav.master" AutoEventWireup="True" Inherits="MerchantTribeStore.BVAdmin_Configuration_MailServer" title="Untitled Page" Codebehind="MailServer.aspx.cs" %>
    ...
    <table border="0" cellspacing="0" cellpadding="5" width="400">
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:ImageButton ImageUrl="~/BVAdmin/Images/Buttons/ok.png" ID="btnSendTest" 
