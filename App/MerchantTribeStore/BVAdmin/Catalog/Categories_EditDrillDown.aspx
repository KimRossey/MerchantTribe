<%@ Page ValidateRequest="false" Title="" Language="C#" MasterPageFile="~/BVAdmin/BVAdmin.master" AutoEventWireup="true" CodeBehind="Categories_EditDrillDown.aspx.cs" Inherits="MerchantTribeStore.BVAdmin.Catalog.Categories_EditDrillDown" %>
...
<asp:ImageButton ID="UpdateButton" TabIndex="2501" runat="server" 
    ...
    <table class="formtable" cellpadding="3">
        <tr>
            <td><asp:ImageButton ID="btnNew" runat="server" AlternateText="Add New Filter Property" ImageUrl="~/BVAdmin/Images/Buttons/new.png"
