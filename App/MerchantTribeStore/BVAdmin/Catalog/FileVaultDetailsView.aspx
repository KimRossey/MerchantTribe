...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:ImageButton ID="ReplaceImageButton" runat="server" AlternateText="Replace" 
                    ImageUrl="~/BVAdmin/Images/Buttons/Replace.png" 
    ...
    <asp:GridView ID="ProductsGridView" runat="server" DataKeyNames="bvin" BorderColor="#CCCCCC"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-Width="50px">
                <ItemTemplate>
                    <asp:ImageButton ID="UpdateImageButton" runat="server" ImageUrl="~/BVAdmin/Images/Buttons/Update.png"
                        CommandName="Update" />
                    <asp:ImageButton ID="RemoveImageButton" runat="server" ImageUrl="~/BVAdmin/Images/Buttons/remove.png"
                        CommandName="Delete" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <asp:Panel ID="pnlAdd" runat="server" Style="padding: 10px; margin: 5px 0 20px 0;"
        ...
        <asp:ImageButton CausesValidation="false" ID="btnAddProductBySku" runat="server"
            AlternateText="Add Product To Order" ImageUrl="~/BVAdmin/Images/Buttons/AddToProduct.png"
        ...
        <asp:Panel CssClass="controlarea1" ID="pnlProductPicker" runat="server" Visible="false">
            ...
            <asp:ImageButton ID="btnProductPickerOkay" runat="server" AlternateText="Add To Product"
                ...
                ImageUrl="~/BVAdmin/Images/Buttons/AddToProduct.png" 
        ...
        <asp:Panel ID="pnlProductChoices" runat="server" Visible="false">
            ...
            AlternateText="Add To Product" ImageUrl="~/BVAdmin/Images/Buttons/AddToProduct.png"
            TabIndex="222" />
        </asp:Panel>
    </asp:Panel>
</asp:Content>
