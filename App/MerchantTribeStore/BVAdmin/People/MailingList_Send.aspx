<%@ Page Language="C#" MasterPageFile="~/BVAdmin/BVAdmin.master" AutoEventWireup="True" Inherits="MerchantTribeStore.BVAdmin_People_MailingList_Send" title="Untitled Page" Codebehind="MailingList_Send.aspx.cs" %>
...
<tr>
    ...
    <td class="formfield"><asp:ImageButton ID="btnPreview" runat="Server" 
            ImageUrl="~/BVAdmin/Images/BUttons/Preview.png" onclick="btnPreview_Click" />&nbsp;&nbsp;<asp:ImageButton 
            ID="btnSend" runat="Server" ImageUrl="~/BVAdmin/Images/BUttons/Ok.png" 
