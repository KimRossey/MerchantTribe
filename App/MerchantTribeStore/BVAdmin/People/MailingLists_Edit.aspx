<%@ Page Language="C#" MasterPageFile="~/BVAdmin/BVAdmin.master" AutoEventWireup="True" Inherits="MerchantTribeStore.BVAdmin_People_MailingLists_Edit" title="Untitled Page" Codebehind="MailingLists_Edit.aspx.cs" %>
...
<h1>
    ...
    <asp:ImageButton ID="btnImport" runat="server" 
            ImageUrl="~/BVAdmin/Images/Buttons/Import.png" ValidationGroup="Import" 
            onclick="btnImport_Click" />&nbsp;
        <asp:ImageButton ID="btnExport" runat="server" 
            ImageUrl="~/BVAdmin/Images/Buttons/Export.png" CausesValidation="False" 
