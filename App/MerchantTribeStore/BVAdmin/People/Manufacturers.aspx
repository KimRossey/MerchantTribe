<%@ Page Language="C#" MasterPageFile="~/BVAdmin/BVAdminNav.master" AutoEventWireup="True" Inherits="MerchantTribeStore.BVAdmin_People_Manufacturers" title="Untitled Page" Codebehind="Manufacturers.aspx.cs" %>
<asp:Content ID="nav" ContentPlaceHolderID="NavContent" runat="server">            
            ...
            <asp:ImageButton ID="btnNew" runat="server" 
                            AlternateText="Add New Manufacturer" 
