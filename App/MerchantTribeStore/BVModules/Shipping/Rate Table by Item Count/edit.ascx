<%@ Control Language="C#" AutoEventWireup="True" Inherits="MerchantTribeStore.BVModules_Shipping_By_Item_Count_edit" Codebehind="edit.ascx.cs" %>
<h1>
    Edit Shipping Method - Rate Table By Total Item Count</h1>
<asp:Panel ID="pnlMain" DefaultButton="btnSave" runat="server">
    ...
    <div class="controlarea2 padded">
                <asp:GridView ID="GridView1" CellPadding="3" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="When Total Item Count is at least">
                            <ItemTemplate>
                                <asp:Label ID="lblLevel" runat="server" Text='<%# Bind("Level") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Charge This Amount Once Per Order">
                            <ItemTemplate>
