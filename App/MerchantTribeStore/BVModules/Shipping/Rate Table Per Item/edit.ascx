<%@ Control Language="C#" AutoEventWireup="True" Inherits="MerchantTribeStore.BVModules_Shipping_Per_Item_edit" Codebehind="edit.ascx.cs" %>
<h1>
    Edit Shipping Method - Rate Table Per Item</h1>
    ...
    <div class="controlarea2 padded">
                <asp:GridView ID="GridView1" CellPadding="3" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Charge This Amount Per Item">
                            <ItemTemplate>
