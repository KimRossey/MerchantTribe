...
{
    public class VendorRepository: ConvertingRepositoryBase<Data.EF.bvc_Vendor, VendorManufacturer>
    {
        ...
        protected override void CopyDataToModel(Data.EF.bvc_Vendor data, VendorManufacturer model)
        {
        ...
        protected override void CopyModelToData(Data.EF.bvc_Vendor data, VendorManufacturer model)
        {
