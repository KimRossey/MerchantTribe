...
namespace BVSoftware.Shipping.FedEx
{
    ...
    public class RateService
    {
                                                 ...
                                                 CarrierCode carCode)
        {
            ...
            //switch ()
            //{
            //    case BVSoftware.Commerce.Shipping.LengthType.Centimeters:
            //        req.Dimensions.Units = DimensionType.CM;
            //        break;
                //case BVSoftware.Commerce.Shipping.LengthType.Inches:
            ...
            //{
            //    case BVSoftware.Commerce.Shipping.WeightType.Kilograms:
            //        req.WeightUnits = WeightType.KGS;
            //        break;
            //    case BVSoftware.Commerce.Shipping.WeightType.Pounds:
