...
namespace BVSoftware.Commerce
{
    ...
    public partial class WebAppSettings
    {
        ...
        public static BVSoftware.Shipping.WeightType ApplicationWeightUnits
        {
            get { return BVSoftware.Shipping.WeightType.Pounds; }
        }
        public static BVSoftware.Shipping.LengthType ApplicationLengthUnits
        {
            get { return BVSoftware.Shipping.LengthType.Inches;}
        }
