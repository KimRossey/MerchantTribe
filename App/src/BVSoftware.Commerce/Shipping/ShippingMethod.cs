...
namespace BVSoftware.Commerce.Shipping
{
	...
	public class ShippingMethod
	{
        ...
        private BVSoftware.Shipping.IShipment ConvertGroupsToShipments(List<ShippingGroup> groups)
        {
            BVSoftware.Shipping.IShipment result = new BVSoftware.Shipping.Shipment();            
		...
		public Collection<ShippingRateDisplay> GetRates(List<ShippingGroup> groups)
		{
			...
			BVSoftware.Shipping.IShippingService p = Shipping.AvailableServices.FindById(this.ShippingProviderId, currentStore);
			if (p != null) {
