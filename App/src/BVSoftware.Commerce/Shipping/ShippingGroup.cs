...
namespace BVSoftware.Commerce.Shipping
{
	...
	public class ShippingGroup
	{
		...
		public static Shipping.DimensionCalculator DimensionCalculator {
            get { return new BVSoftware.Commerce.Shipping.DefaultDimensionCalculator(); }
		}
        ...
        public BVSoftware.Shipping.IShippable AsIShippable()
        {
            this.GenerateDimensions();
            BVSoftware.Shipping.Shippable result = new BVSoftware.Shipping.Shippable();
