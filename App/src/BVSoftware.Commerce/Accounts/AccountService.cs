...
namespace BVSoftware.Commerce.Accounts
{
    ...
    {        
        ...
        public Store CreateAndSetupStore(string storeName,
                                                ...
                                                int plan,
                                                decimal rate,
                                                BVSoftware.Billing.BillingAccount billingAccount)
        {
            Store s = null;
            ...
            if (s != null)
            {
                ...
                BVSoftware.Billing.Service svc = new BVSoftware.Billing.Service(WebAppSettings.ApplicationConnectionString);
