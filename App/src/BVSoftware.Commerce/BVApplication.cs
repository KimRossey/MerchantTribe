...
namespace BVSoftware.Commerce
{
    public class BVApplication
    {
        ...
        private BVSoftware.Commerce.RequestContext _CurrentRequestContext = new BVSoftware.Commerce.RequestContext();
        ...
        public BVSoftware.CommerceDTO.v1.Catalog.ClearProductsData ClearProducts(int howMany)
        {
            BVSoftware.CommerceDTO.v1.Catalog.ClearProductsData result = new CommerceDTO.v1.Catalog.ClearProductsData();
        ...
        private BVSoftware.CommerceDTO.v1.Catalog.ClearProductsData DeleteSome(long storeId, int howMany)
        {
        ...
        // Themes
        public BVSoftware.Commerce.Content.ThemeManager ThemeManager()
        {
