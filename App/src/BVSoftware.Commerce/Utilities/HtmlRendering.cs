...
namespace BVSoftware.Commerce.Utilities
{
    public class HtmlRendering
    {
        ...
        string imageUrl 
            = BVSoftware.Commerce.Storage.DiskStorage.ProductImageUrlSmall(
        ...
        public static string HeaderLinks(BVApplication bvapp, string currentUserId)
        {
            ...
            else
            {
                ...
                BVSoftware.Commerce.Membership.CustomerAccount a = bvapp.MembershipServices.Customers.Find(currentUserId);
                if (a != null)
                {
                    name = a.Email;
                }
